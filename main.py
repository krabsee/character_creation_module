"""
Game module for character selection.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """The function will return damage to the enemy
...
def defence(char_name: str, char_class: str) -> str:
    """The function will return blocked damage
    depending on the character class.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """The function will return used specials skills
    depending on the character class.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """The function starting training"""
    if char_class == 'warrior':
